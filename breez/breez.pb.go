...
type GetFundLimitsReply struct {
	...
	MaxLocalBalance  int64 `protobuf:"varint,2,opt,name=maxLocalBalance" json:"maxLocalBalance,omitempty"`
}
...
func (m *GetFundLimitsReply) GetMaxLocalBalance() int64 {
	if m != nil {
		return m.MaxLocalBalance
	}
	return 0
}
...
var fileDescriptor0 = []byte{
	...
	,
}
