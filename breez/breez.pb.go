...
It has these top-level messages:
	...
	AddFundStatusReply
	GetMaxAllowedDepositRequest
	GetMaxAllowedDepositReply
	RemoveFundRequest
	RemoveFundReply
...
type GetMaxAllowedDepositRequest struct {
	LightningID string `protobuf:"bytes,1,opt,name=lightningID" json:"lightningID,omitempty"`
}

func (m *GetMaxAllowedDepositRequest) Reset()                    { *m = GetMaxAllowedDepositRequest{} }
func (m *GetMaxAllowedDepositRequest) String() string            { return proto.CompactTextString(m) }
func (*GetMaxAllowedDepositRequest) ProtoMessage()               {}
func (*GetMaxAllowedDepositRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }

func (m *GetMaxAllowedDepositRequest) GetLightningID() string {
	if m != nil {
...
type GetMaxAllowedDepositReply struct {
	MaxAmount int64 `protobuf:"varint,1,opt,name=maxAmount" json:"maxAmount,omitempty"`
}

func (m *GetMaxAllowedDepositReply) Reset()                    { *m = GetMaxAllowedDepositReply{} }
func (m *GetMaxAllowedDepositReply) String() string            { return proto.CompactTextString(m) }
func (*GetMaxAllowedDepositReply) ProtoMessage()               {}
func (*GetMaxAllowedDepositReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *GetMaxAllowedDepositReply) GetMaxAmount() int64 {
	if m != nil {
		return m.MaxAmount
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*GetMaxAllowedDepositRequest)(nil), "breez.GetMaxAllowedDepositRequest")
	proto.RegisterType((*GetMaxAllowedDepositReply)(nil), "breez.GetMaxAllowedDepositReply")
...
type FundManagerClient interface {
	...
	GetMaxAllowedDeposit(ctx context.Context, in *GetMaxAllowedDepositRequest, opts ...grpc.CallOption) (*GetMaxAllowedDepositReply, error)
}
...
func (c *fundManagerClient) GetMaxAllowedDeposit(ctx context.Context, in *GetMaxAllowedDepositRequest, opts ...grpc.CallOption) (*GetMaxAllowedDepositReply, error) {
	out := new(GetMaxAllowedDepositReply)
	err := grpc.Invoke(ctx, "/breez.FundManager/GetMaxAllowedDeposit", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FundManagerServer interface {
	...
	GetMaxAllowedDeposit(context.Context, *GetMaxAllowedDepositRequest) (*GetMaxAllowedDepositReply, error)
}
...
func _FundManager_GetMaxAllowedDeposit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMaxAllowedDepositRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FundManagerServer).GetMaxAllowedDeposit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.FundManager/GetMaxAllowedDeposit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FundManagerServer).GetMaxAllowedDeposit(ctx, req.(*GetMaxAllowedDepositRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _FundManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetMaxAllowedDeposit",
			Handler:    _FundManager_GetMaxAllowedDeposit_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "breez.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
