...
var file_breez_proto_rawDesc = []byte{
	...
	0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x32, 0x89, 0x01, 0x0a, 0x08, 0x49, 0x6e, 0x76, 0x6f, 0x69,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x69, 0x0a, 0x07, 0x53, 0x75,
...
var file_breez_proto_msgTypes = make([]protoimpl.MessageInfo, 74)
var file_breez_proto_goTypes = []interface{}{
	...
	(*ReportPaymentFailureRequest)(nil),                          // 72: breez.ReportPaymentFailureRequest
	(*ReportPaymentFailureReply)(nil),                            // 73: breez.ReportPaymentFailureReply
	nil,                                                          // 74: breez.LSPListReply.LspsEntry
	(*AddFundStatusReply_AddressStatus)(nil),                     // 75: breez.AddFundStatusReply.AddressStatus
	nil,                                                          // 76: breez.AddFundStatusReply.StatusesEntry
}
var file_breez_proto_depIdxs = []int32{
	...
	74, // 2: breez.LSPListReply.lsps:type_name -> breez.LSPListReply.LspsEntry
	76, // 3: breez.AddFundStatusReply.statuses:type_name -> breez.AddFundStatusReply.StatusesEntry
	...
	75, // 9: breez.AddFundStatusReply.StatusesEntry.value:type_name -> breez.AddFundStatusReply.AddressStatus
	...
	72, // 46: breez.Support.ReportPaymentFailure:input_type -> breez.ReportPaymentFailureRequest
	44, // 47: breez.Invoicer.RegisterDevice:output_type -> breez.RegisterReply
	46, // 48: breez.Invoicer.SendInvoice:output_type -> breez.InvoiceReply
	52, // 49: breez.CardOrderer.Order:output_type -> breez.OrderReply
	44, // 50: breez.Pos.RegisterDevice:output_type -> breez.RegisterReply
	48, // 51: breez.Pos.UploadLogo:output_type -> breez.UploadFileReply
	50, // 52: breez.Information.Ping:output_type -> breez.PingReply
	13, // 53: breez.Information.Rates:output_type -> breez.RatesReply
	69, // 54: breez.Information.BreezAppVersions:output_type -> breez.BreezAppVersionsReply
	10, // 55: breez.Information.ReceiverInfo:output_type -> breez.ReceiverInfoReply
	17, // 56: breez.ChannelOpener.LSPList:output_type -> breez.LSPListReply
	23, // 57: breez.ChannelOpener.OpenLSPChannel:output_type -> breez.OpenLSPChannelReply
	19, // 58: breez.ChannelOpener.RegisterPayment:output_type -> breez.RegisterPaymentReply
	21, // 59: breez.ChannelOpener.CheckChannels:output_type -> breez.CheckChannelsReply
	27, // 60: breez.PublicChannelOpener.OpenPublicChannel:output_type -> breez.OpenPublicChannelReply
	25, // 61: breez.FundManager.OpenChannel:output_type -> breez.OpenChannelReply
	30, // 62: breez.FundManager.UpdateChannelPolicy:output_type -> breez.UpdateChannelPolicyReply
	32, // 63: breez.FundManager.AddFundInit:output_type -> breez.AddFundInitReply
	34, // 64: breez.FundManager.AddFundStatus:output_type -> breez.AddFundStatusReply
	36, // 65: breez.FundManager.RemoveFund:output_type -> breez.RemoveFundReply
	38, // 66: breez.FundManager.RedeemRemovedFunds:output_type -> breez.RedeemRemovedFundsReply
	40, // 67: breez.FundManager.GetSwapPayment:output_type -> breez.GetSwapPaymentReply
	62, // 68: breez.FundManager.RegisterTransactionConfirmation:output_type -> breez.RegisterTransactionConfirmationResponse
	32, // 69: breez.Swapper.AddFundInit:output_type -> breez.AddFundInitReply
	34, // 70: breez.Swapper.AddFundStatus:output_type -> breez.AddFundStatusReply
	40, // 71: breez.Swapper.GetSwapPayment:output_type -> breez.GetSwapPaymentReply
	42, // 72: breez.Swapper.RedeemSwapPayment:output_type -> breez.RedeemSwapPaymentReply
	71, // 73: breez.Swapper.GetReverseRoutingNode:output_type -> breez.GetReverseRoutingNodeReply
	58, // 74: breez.CTP.JoinCTPSession:output_type -> breez.JoinCTPSessionResponse
	60, // 75: breez.CTP.TerminateCTPSession:output_type -> breez.TerminateCTPSessionResponse
	54, // 76: breez.NodeInfo.SetNodeInfo:output_type -> breez.SetNodeInfoResponse
	56, // 77: breez.NodeInfo.GetNodeInfo:output_type -> breez.GetNodeInfoResponse
	64, // 78: breez.SyncNotifier.RegisterPeriodicSync:output_type -> breez.RegisterPeriodicSyncResponse
	67, // 79: breez.PushTxNotifier.RegisterTxNotification:output_type -> breez.PushTxNotificationResponse
	6,  // 80: breez.InactiveNotifier.InactiveNotify:output_type -> breez.InactiveNotifyResponse
	8,  // 81: breez.PaymentNotifier.RegisterPaymentNotification:output_type -> breez.RegisterPaymentNotificationResponse
	4,  // 82: breez.Signer.SignUrl:output_type -> breez.SignUrlResponse
	73, // 83: breez.Support.ReportPaymentFailure:output_type -> breez.ReportPaymentFailureReply
