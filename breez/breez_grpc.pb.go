...
func RegisterPaymentNotifierServer(s *grpc.Server, srv PaymentNotifierServer) {
	s.RegisterService(&_PaymentNotifier_serviceDesc, srv)
}
...
var _PaymentNotifier_serviceDesc = grpc.ServiceDesc{
