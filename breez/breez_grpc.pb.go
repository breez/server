...
func (c *informationClient) ChainApiServers(ctx context.Context, in *ChainApiServersRequest, opts ...grpc.CallOption) (*ChainApiServersReply, error) {
	out := new(ChainApiServersReply)
	err := c.cc.Invoke(ctx, "/breez.Information/ChainApiServers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Information_ChainApiServers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ChainApiServersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InformationServer).ChainApiServers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.Information/ChainApiServers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InformationServer).ChainApiServers(ctx, req.(*ChainApiServersRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
type taprootSwapperClient struct {
	cc grpc.ClientConnInterface
}

func NewTaprootSwapperClient(cc grpc.ClientConnInterface) TaprootSwapperClient {
	return &taprootSwapperClient{cc}
}

func (c *taprootSwapperClient) CreateSwap(ctx context.Context, in *CreateSwapRequest, opts ...grpc.CallOption) (*CreateSwapResponse, error) {
	out := new(CreateSwapResponse)
	err := c.cc.Invoke(ctx, "/breez.TaprootSwapper/CreateSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootSwapperClient) PaySwap(ctx context.Context, in *PaySwapRequest, opts ...grpc.CallOption) (*PaySwapResponse, error) {
	out := new(PaySwapResponse)
	err := c.cc.Invoke(ctx, "/breez.TaprootSwapper/PaySwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootSwapperClient) RefundSwap(ctx context.Context, in *RefundSwapRequest, opts ...grpc.CallOption) (*RefundSwapResponse, error) {
	out := new(RefundSwapResponse)
	err := c.cc.Invoke(ctx, "/breez.TaprootSwapper/RefundSwap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taprootSwapperClient) SwapParameters(ctx context.Context, in *SwapParametersRequest, opts ...grpc.CallOption) (*SwapParametersResponse, error) {
	out := new(SwapParametersResponse)
	err := c.cc.Invoke(ctx, "/breez.TaprootSwapper/SwapParameters", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// TaprootSwapperServer is the server API for TaprootSwapper service.
// All implementations must embed UnimplementedTaprootSwapperServer
// for forward compatibility
type TaprootSwapperServer interface {
	...
	mustEmbedUnimplementedTaprootSwapperServer()
}
...
func (UnimplementedTaprootSwapperServer) PaySwap(context.Context, *PaySwapRequest) (*PaySwapResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PaySwap not implemented")
}
...
func (UnimplementedTaprootSwapperServer) SwapParameters(context.Context, *SwapParametersRequest) (*SwapParametersResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SwapParameters not implemented")
}
func (UnimplementedTaprootSwapperServer) mustEmbedUnimplementedTaprootSwapperServer() {}

// UnsafeTaprootSwapperServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to TaprootSwapperServer will
// result in compilation errors.
...
func RegisterTaprootSwapperServer(s grpc.ServiceRegistrar, srv TaprootSwapperServer) {
	s.RegisterService(&TaprootSwapper_ServiceDesc, srv)
}

func _TaprootSwapper_CreateSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateSwapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaprootSwapperServer).CreateSwap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.TaprootSwapper/CreateSwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaprootSwapperServer).CreateSwap(ctx, req.(*CreateSwapRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaprootSwapper_PaySwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PaySwapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaprootSwapperServer).PaySwap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.TaprootSwapper/PaySwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaprootSwapperServer).PaySwap(ctx, req.(*PaySwapRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaprootSwapper_RefundSwap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefundSwapRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaprootSwapperServer).RefundSwap(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.TaprootSwapper/RefundSwap",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaprootSwapperServer).RefundSwap(ctx, req.(*RefundSwapRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _TaprootSwapper_SwapParameters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SwapParametersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaprootSwapperServer).SwapParameters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.TaprootSwapper/SwapParameters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaprootSwapperServer).SwapParameters(ctx, req.(*SwapParametersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// TaprootSwapper_ServiceDesc is the grpc.ServiceDesc for TaprootSwapper service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
...
func NewPaymentNotifierClient(cc grpc.ClientConnInterface) PaymentNotifierClient {
	return &paymentNotifierClient{cc}
}

func (c *paymentNotifierClient) RegisterPaymentNotification(ctx context.Context, in *RegisterPaymentNotificationRequest, opts ...grpc.CallOption) (*RegisterPaymentNotificationResponse, error) {
	out := new(RegisterPaymentNotificationResponse)
	err := c.cc.Invoke(ctx, "/breez.PaymentNotifier/RegisterPaymentNotification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnsafePaymentNotifierServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to PaymentNotifierServer will
// result in compilation errors.
...
func RegisterPaymentNotifierServer(s grpc.ServiceRegistrar, srv PaymentNotifierServer) {
	s.RegisterService(&PaymentNotifier_ServiceDesc, srv)
}

func _PaymentNotifier_RegisterPaymentNotification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterPaymentNotificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PaymentNotifierServer).RegisterPaymentNotification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.PaymentNotifier/RegisterPaymentNotification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentNotifierServer).RegisterPaymentNotification(ctx, req.(*RegisterPaymentNotificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (c *supportClient) ReportPaymentFailure(ctx context.Context, in *ReportPaymentFailureRequest, opts ...grpc.CallOption) (*ReportPaymentFailureReply, error) {
	out := new(ReportPaymentFailureReply)
	err := c.cc.Invoke(ctx, "/breez.Support/ReportPaymentFailure", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *supportClient) BreezStatus(ctx context.Context, in *BreezStatusRequest, opts ...grpc.CallOption) (*BreezStatusReply, error) {
	out := new(BreezStatusReply)
	err := c.cc.Invoke(ctx, "/breez.Support/BreezStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSupportServer) ReportPaymentFailure(context.Context, *ReportPaymentFailureRequest) (*ReportPaymentFailureReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReportPaymentFailure not implemented")
}
func (UnimplementedSupportServer) BreezStatus(context.Context, *BreezStatusRequest) (*BreezStatusReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BreezStatus not implemented")
}
...
func _Support_ReportPaymentFailure_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportPaymentFailureRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupportServer).ReportPaymentFailure(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.Support/ReportPaymentFailure",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupportServer).ReportPaymentFailure(ctx, req.(*ReportPaymentFailureRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Support_BreezStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BreezStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SupportServer).BreezStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/breez.Support/BreezStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SupportServer).BreezStatus(ctx, req.(*BreezStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
