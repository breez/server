...
require (
	...
	github.com/lightningnetwork/lightning-onion v1.2.1-0.20230803185733-258028a7e4d9 // indirect
...
replace github.com/lightningnetwork/lnd => github.com/breez/lnd v0.15.0-beta.rc6.0.20230902183744-9e3f322824f5
